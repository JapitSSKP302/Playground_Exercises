...
defender.moveRight()
print("The current position of the defender is : \(defender.position)")
defender.fire()
print("The remainig fire power is : \(defender.remainingFirePower)")
...
print("The shield strength is : \(defender.health)")
...
defender.wasHit()
defender.wasHit()
print("The  strength is : \(defender.health)")
