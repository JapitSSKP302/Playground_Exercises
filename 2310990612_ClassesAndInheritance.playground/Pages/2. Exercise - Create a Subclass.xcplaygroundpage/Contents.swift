...
print("The position of the destroyer is \(destroyer.position)")
destroyer.moveRight()
print("The new position of the destroyer is \(destroyer.position)")
...
//falcon.weapon
print("The print doent work as the weapon property is the property of the class fighter and not the property of falcon neither the porperty of Spaceship class which falcon inherits\n")
