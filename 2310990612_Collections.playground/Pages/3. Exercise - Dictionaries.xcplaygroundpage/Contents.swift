...
var dict:[String:[String]] = ["Shapes":shapesArray,"Color":colorsArray]
...
print(dict)
//the last color in the colorsArray was Blue
if let colors = dict["Color"] {
